    ...
    it('should preview template in a new tab', function (done) {
      ...
      browser.getAllWindowHandles().then(function (handles) {
        ...
        browser.switchTo().window(newWindowHandle).then(function () {
          expect(browser.driver.getCurrentUrl()).to.eventually.contain('https://stage-test-dot-rvaviewer-test.appspot.com/?type=presentation&id=ebbb1b89-166e-41fb-9adb-d0052132b0df');
