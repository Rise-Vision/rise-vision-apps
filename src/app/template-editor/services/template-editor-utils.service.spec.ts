...
describe('TemplateEditorUtilsService', () => {
  let sandbox = sinon.sandbox.create();

  let templateEditorUtils: TemplateEditorUtilsService;
  ...
  beforeEach(() => {
    ...
    templateEditorUtils = TestBed.inject(TemplateEditorUtilsService);
  });
  ...
  it('should be created', () => {
    expect(templateEditorUtils).to.be.ok;
  });
  ...
  describe('showInvalidExtensionsMessage', function () {
    it('should call the correct functions', function () {
      ...
      templateEditorUtils.getValidExtensionsMessage.should.have.been.called;
    });
  });
  ...
  describe('showMessageWindow', function() {
    it('should show message', function() {
      ...
      modalService.showMessage.should.have.been.calledWith('title','message');
    })
  });
