...
(function (angular) {
  ...
  angular.module('risevision.common.config')
    .value('CORE_URL', 'https://new-user-trial-dot-rvacore-test.appspot.com/_ah/api'); // override default core value
  ...
  angular.module('risevision.apps.config', [])
    ...
    .value('STORE_ENDPOINT_URL',
      'https://information-disclosure-dot-store-dot-rvacore-test.appspot.com/_ah/api') // override default Store server value
    .value('STORE_SERVER_URL', 'https://information-disclosure-dot-store-dot-rvacore-test.appspot.com/')
    ...
    .value('MESSAGING_PRESENCE_URL',
      'https://services-stage.risevision.com/messaging/presence')
    .value('APPS_URL', '')
    .value('ENV_NAME', 'TEST')
