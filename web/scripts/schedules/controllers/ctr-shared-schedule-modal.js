...
<div style="background:#f2f2f2;color:#020620;font-family:Helvetica;font-size:12px;padding:5px;text-align:center;">\n\
  ...
  .controller('SharedScheduleModalController', ['$scope', '$modalInstance', 'scheduleFactory', '$window', 'SHARED_SCHEDULE_LINK', 'SHARED_SCHEDULE_EMBED_CODE',
    function ($scope, $modalInstance, scheduleFactory, $window, SHARED_SCHEDULE_LINK, SHARED_SCHEDULE_EMBED_CODE) {
      ...
      $scope.sharedScheduleEmbedCode = SHARED_SCHEDULE_EMBED_CODE.replace('SHARED_SCHEDULE_LINK', $scope.sharedScheduleLink);
